...
class TypeScriptLanguageClient extends AutoLanguageClient {
  getGrammarScopes (): string[] { return atom.config.get('ide-typescript.javascriptSupport') ? [ 'source.ts', 'source.tsx', 'source.js', 'source.js.jsx' ] : [ 'source.ts', 'source.tsx' ] }
  getLanguageName (): string { return 'TypeScript' }
  getServerName (): string { return 'SourceGraph' }
